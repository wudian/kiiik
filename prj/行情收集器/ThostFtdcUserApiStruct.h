...
public:
	CThostFtdcDepthMarketDataField& operator=(CThostFtdcDepthMarketDataField& a)  //赋值函数
	{
		memcpy(this,&a,sizeof(a));
		return *this;
	}

	CThostFtdcDepthMarketDataField (const CThostFtdcDepthMarketDataField& obj)  //拷贝构造函数
	{
		memcpy(this, &obj, sizeof(CThostFtdcDepthMarketDataField));
	}

	CThostFtdcDepthMarketDataField ()
	{
		memset(this, 0, sizeof(CThostFtdcDepthMarketDataField));
	}
